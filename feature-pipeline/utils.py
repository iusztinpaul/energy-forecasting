...
def save_json(data: dict, file_name: str = ".metadata.json", save_dir: str = settings.OUTPUT_DIR):
    """
...
def load_json(file_name: str = ".metadata.json", save_dir: str = settings.OUTPUT_DIR) -> dict:
    """
    Load a JSON file.
